...
// Messages FR pour les codes d'erreur OAuth courants renvoyés par GLPI
...
/** Transforme une erreur OAuth en message lisible (FR) */
...
/**
 * fetch authentifié vers l'API GLPI, avec rafraîchissement
 * automatique du token sur une réponse 401.
 */
